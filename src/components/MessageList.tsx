...
export const MessageList: React.FC = () => {
  ...
  const lookingText = useMemo(() => {
    ...
    if (lookingAgents.length === 1) {
      return `${lookingAgents[0].userName} is viewing`;
    }
    if (lookingAgents.length === 2) {
      return `${lookingAgents[0].userName} and ${lookingAgents[1].userName} are viewing`;
    }
    return `${lookingAgents[0].userName} and ${lookingAgents.length - 1} others are viewing`;
  }, [lookingAgents]);
  ...
  const buildTypingText = () => {
    ...
    return `${typingNames[0]}, ${typingNames[1]} and ${others} others are typing`;
  };
