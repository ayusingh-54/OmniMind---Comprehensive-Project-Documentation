                ...
                >
                    <div className="agent-selector-header">
                        <div className="agent-selector-header-text">
                            <div className="agent-selector-title">Select AI Agent</div>
                            <div className="agent-selector-subtitle">{activeCount} online · {sortedAgents.length} available</div>
                        </div>
                                ...
                                >
                                    ...
                                    <div className="agent-selector-info">
                                        <div className="agent-selector-name">
                                            {agent.name}
                                            {!isActive && (
                                                <span className="agent-selector-offline">Offline</span>
                                            )}
                                        </div>
